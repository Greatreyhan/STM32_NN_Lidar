...
#define AI_NET_OBJ_INSTANCE g_lidar_model
 
#undef AI_LIDAR_MODEL_MODEL_SIGNATURE
#define AI_LIDAR_MODEL_MODEL_SIGNATURE     "bd8c017652d9ad68bcbd99836c365cc9"
...
#undef AI_LIDAR_MODEL_N_BATCHES
#define AI_LIDAR_MODEL_N_BATCHES         (1)

static ai_ptr g_lidar_model_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_lidar_model_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    896, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_LIDAR_MODEL_IN_NUM, &serving_default_dense_9_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_LIDAR_MODEL_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_LIDAR_MODEL_MODEL_NAME,
      .model_signature   = AI_LIDAR_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_lidar_model_forward(ai_handle network, const ai_buffer* input)
{
