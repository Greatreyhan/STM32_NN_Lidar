...
#ifndef AI_LIDAR_MODEL_H
#define AI_LIDAR_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_LIDAR_MODEL_MODEL_NAME          "lidar_model"
#define AI_LIDAR_MODEL_ORIGIN_MODEL_NAME   "ydlidargs2"

/******************************************************************************/
#define AI_LIDAR_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LIDAR_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LIDAR_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_LIDAR_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_LIDAR_MODEL_IN \
  ai_lidar_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LIDAR_MODEL_IN_SIZE { \
  AI_LIDAR_MODEL_IN_1_SIZE, \
}
#define AI_LIDAR_MODEL_IN_SIZE_BYTES { \
  AI_LIDAR_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_LIDAR_MODEL_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_LIDAR_MODEL_IN_1_CHANNEL     (160)
#define AI_LIDAR_MODEL_IN_1_SIZE        (160)
#define AI_LIDAR_MODEL_IN_1_SIZE_BYTES  (640)

/******************************************************************************/
#define AI_LIDAR_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LIDAR_MODEL_OUT \
  ai_lidar_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LIDAR_MODEL_OUT_SIZE { \
  AI_LIDAR_MODEL_OUT_1_SIZE, \
}
#define AI_LIDAR_MODEL_OUT_SIZE_BYTES { \
  AI_LIDAR_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_LIDAR_MODEL_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_LIDAR_MODEL_OUT_1_CHANNEL     (3)
#define AI_LIDAR_MODEL_OUT_1_SIZE        (3)
#define AI_LIDAR_MODEL_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_LIDAR_MODEL_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup lidar_model
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_lidar_model_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_lidar_model_get_report(
  ai_handle network, ai_network_report* report);
 ...
 * using @ref ai_lidar_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_lidar_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_lidar_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_LIDAR_MODEL_*
 * defines into file @ref lidar_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_lidar_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_LIDAR_MODEL_H */
